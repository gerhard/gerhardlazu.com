...
p(heading). A lot of you have been asking for scripts to populate the values which appear under custom fields in the Write tab, this release makes that possible.
...
p(heading). The Date Picker field got a new friend, the Time Picker.
