module DisqusInitializer
  def self.registered(app)
    ...
    Disqus.defaults.update({
      ...
      :account         => "gerhardlazu",               # your disqus account
      :developer       => Padrino.env == :development, # allows threads to work on localhost
      :container_id    => 'disqus',                    # desired thread container
      ...
      :show_powered_by => false,                       # show or hide powered by line
